...
Config.Employ = {
	...
	Workers = {
		{
			identifier = 'steam:0000', -- Add whitelisted workers // enter job system
			grade = 4
		}
	},
        ...
        data = {
            ...
            wheels = {
                ...
                },
                {
                    ...
                    commands = {"prop_roadcone02a", "prop_cs_trolley_01", "prop_engine_hoist", "prop_tool_box_04"}
                }
            }
        }
    }
...
function RegisterLS()
	if (GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId(-1)), Config.Zones.ls1.Pos.x, Config.Zones.ls1.Pos.y, Config.Zones.ls1.Pos.z, true) < Config.DrawDistance) then
	Config.Menus = {
		main = {
			label = 'LS CUSTOMS',
			parent = nil,
	...
	elseif (GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId(-1)), Config.Zones.ls2.Pos.x, Config.Zones.ls2.Pos.y, Config.Zones.ls2.Pos.z, true) < Config.DrawDistance) then
		Config.Menus = {
			main = {
				label = 'LS CUSTOMS',
				parent = nil,
	...
	elseif (GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId(-1)), Config.Zones.ls3.Pos.x, Config.Zones.ls3.Pos.y, Config.Zones.ls3.Pos.z, true) < Config.DrawDistance) then
		Config.Menus = {
			main = {
				label = 'LS CUSTOMS',
				parent = nil,
